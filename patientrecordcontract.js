...
class PatientRecordContract extends Contract {
   ...
   async queryByGender(ctx, gender) {
     //  GRADED FUNCTION
    //   TASK-4: Write the couchDB selector that queries using the gender
   ...
   async queryByBlood_Type(ctx, blood_type) {
       //   GRADED FUNCTION
      //   TASK-5: Write a couchDB selector query that queries using blood_type
      //  and uses te index created for bloodType
    let queryString = {
        // "selector": {
        //     "fieldname": arg_val
        // },
